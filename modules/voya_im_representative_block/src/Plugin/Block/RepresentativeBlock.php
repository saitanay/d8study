...
class RepresentativeBlock extends BlockBase {
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    ...
    //$mydata = $form_state->getValue('anonymous_title');
    //print_r($mydata);die;
  ...
  public function build() {
    if (\Drupal::currentUser()->isAuthenticated()) {
      ...
      $block_title = $this->configuration['anonymous_title'];
      $block_body = $this->configuration['anonymous_body'];
      $build = [
        '#theme' => 'representative_anonymous_block',
